...
Abstract: Recent studies show that technology adoption and innovation by firms can lead to labour up-skilling and may exacerbate wage polarisation in industrialised countries. Investments in Research and Development is one way for firms to adopt new technologies, which are incentivized by pro-technology policies. The resulting changes in the structure of production will likely impact factor use of both adopting firms and firms connected to them through spillovers. For this reason, the social return on R&D spending is often deemed to be higher than their private return. This paper models and estimates how French policies for research and innovation (CIR) shape the organisation of production and quantifies how innovation spillovers affect networks of firms.
